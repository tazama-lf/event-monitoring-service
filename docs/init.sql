-- the table that TCS makes:
CREATE TABLE IF NOT EXISTS public.config
(
    id integer NOT NULL DEFAULT nextval('config_id_seq'::regclass),
    msg_fam character varying(255) COLLATE pg_catalog."default" NOT NULL,
    transaction_type character varying(255) COLLATE pg_catalog."default" NOT NULL,
    endpoint_path character varying(255) COLLATE pg_catalog."default" NOT NULL,
    version character varying(255) COLLATE pg_catalog."default" NOT NULL DEFAULT 'v1'::character varying,
    content_type character varying(255) COLLATE pg_catalog."default" NOT NULL DEFAULT 'application/json'::character varying,
    ...
    status character varying(255) COLLATE pg_catalog."default" NOT NULL DEFAULT 'inprogress'::character varying,
    functions jsonb,
