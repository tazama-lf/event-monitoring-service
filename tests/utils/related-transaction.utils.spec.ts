...
describe('processRelatedTransactionMapping (issue #82: two-tier DataCache cache)', () => {
  ...
  it('on a Redis cache MISS (empty string, matching RedisService.getJson): falls back to the database, identical to pre-#82 behavior', async () => {
    const loggerService = makeLoggerService();
